...
临近毕业，我决定把我做过编程类的项目全部拿出来共享。
这些项目均获得 H1 及以上（约95%）评价，现以 MIT 协议发布，供后来者学习、参考或再开发使用。
 希望能为未来的同学和开源学习者提供一点帮助。
...
| 课程代码  | 课程名称   | 项目名称                                     | 仓库链接                                                 |
| --- | --- | --- | --- |
| COMP90041 | 编程与软件开发 | Musify App 音乐管理程序                    | [GitHub](https://github.com/mortalreminderpt/Musify-App) |
...
作为坚定的共享主义战士，所有项目均遵循 MIT 协议，任何人都可以自由学习、修改或在注明来源的前提下使用。
